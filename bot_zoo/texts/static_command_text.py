from bot_zoo.commands.static_commands import (
    HELP_COMMAND,
    ABOUT_COMMAND,
    CONTACTS_COMMAND,
    CREATORS_COMMAND,
...
from bot_zoo.commands.quiz_commands import START_QUIZ_COMMAND
...
CONTACTS_COMMAND_TEXT = 'Для связи по программе опеки:+7 (958) 813-15-60, a.sharapova@moscowzoo.ru. Актуальная информация о том, как связаться с зоопарком и добраться до нас:'
