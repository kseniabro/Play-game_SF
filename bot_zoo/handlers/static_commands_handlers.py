...
from bot_zoo.keyboards.about_kb import about_inline_keyboard
from bot_zoo.keyboards.contacts_kb import zoo_contacts_inline_keyboard
...
from bot_zoo.texts.static_command_text import (
    START_COMMAND_TEXT,
    HELP_COMMAND_TEXT,
